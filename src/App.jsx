      ...
      <div>
        ...
        <div style={C.grid2}>
          <div style={C.card()}>
            ...
            <div style={{ color:"#475569", fontSize:"11px", marginBottom:"10px" }}>Paste job description → get complete tailored CV sections ready to copy into your CV</div>
            ...
            <button style={{ ...C.btnS("#a78bfa"), marginTop:"8px", width:"100%" }} onClick={async()=>{
              ...
              const r = await claude(`You are tailoring Sachin Jadhav's CV for a specific job. Use his ACTUAL CV content below as the base and tailor each section to match the job description.

SACHIN'S ACTUAL CV:
---
NAME: Sachin Jadhav
CURRENT ROLE: Vice President (P4) — Regional Head, Business Lending Group, CSB Bank Ltd, Pune (Apr 2025–Present)
PREVIOUS: Deputy Vice President — Regional Head, Business & Portfolio Performance, IndusInd Bank Ltd, Pune (Jun 2016–Mar 2025, 9 Years)
EARLIER: Senior Manager — Credit & Portfolio Monitoring, Yes Bank Ltd (Dec 2015–Jun 2016)
EARLIEST: Area Manager — Agri & MSME, ING Vysya Bank | Axis Bank | South Indian Bank (2006–2015)

EXPERTISE: Portfolio Performance Analytics, MIS Design & Executive Dashboards, KPI Frameworks, YoY/QoQ Trend & Variance Analysis, Delinquency & NPA Analytics, Early Warning Indicators, Credit Risk Decision Support, Business Intelligence & Reporting, Risk Monitoring & Governance

TOOLS: MS Excel (Advanced — pivot tables, scenario modelling, dynamic dashboards), Power BI (Intermediate — DAX, portfolio KPI dashboards), Tableau (Intermediate), SQL (Working knowledge), Python (Applied/learning — Pandas, NumPy)

KEY ACHIEVEMENTS:
- Managed Rs500+ Crore regional portfolio at IndusInd Bank
- Built regional KPI and MIS framework from scratch
- Designed portfolio dashboards tracking NPA trends, yield, fee income, delinquency buckets
- Presented executive dashboards to C-suite monthly/quarterly
- Recognised as Best Regional Head (2018–19)
- Awards: Best RM West Zone (2013–14), Best SRM West Zone (2014–15) at ING Vysya Bank

EDUCATION: B.Sc. Agriculture, MPKV Rahuri | Sainik School Satara (CBSE)
CERTIFICATIONS: CAIIB, JAIIB, Executive PGP in Business Analytics (InGrade, In Progress), Business Analytics (Microsoft & IBM), GEN AI Certification, Python for Data Analytics

ANALYTICS PROJECTS:
- Portfolio Performance Dashboard (Power BI, Advanced Excel) — SME loan portfolio KPIs including disbursements, NPA buckets, yield trends
- Customer Segmentation & Risk Bucketing (Excel, Python/Pandas) — segmented by risk profile, ticket size, delinquency
- Sales & Revenue Forecasting Model (Advanced Excel, Power BI) — regional disbursement targets and fee income projection
- Fraud & Anomaly Detection (Python — Pandas, NumPy, Excel) — rule-based anomaly detection on loan transaction data
---

JOB DESCRIPTION TO TAILOR FOR:
${jd}

Now generate these tailored CV sections:

1. PROFESSIONAL TITLE
(5-6 words, tailored exactly to this role)

2. PROFESSIONAL SUMMARY
(3 sentences, ATS-optimised with keywords from JD, first-person, under 80 words)

3. KEY SKILLS LIST
(12 bullet points — use exact keywords from JD where they match Sachin's skills)

4. TOP 3 ACHIEVEMENTS TO HIGHLIGHT
(Rewrite 3 of his real achievements to directly address what this role needs, keep numbers)

5. EXPERIENCE BULLETS TO ADD/MODIFY
(3-4 new bullet points for his current/recent role that match this JD's requirements)

6. ATS KEYWORDS TO INCLUDE
(15 keywords from JD to weave into the CV)

7. SECTIONS TO EMPHASISE
(Which experience or projects to put first for this specific role)

Be specific, use his real experience, do not invent anything.`);
              setCvOut(r); setCvLoad(false);
            }} disabled={cvLoad||!jd}>{cvLoad?"Tailoring CV...":"🎯 Generate Full CV Tailoring"}</button>
            {cvOut && (
              <div style={C.aibox}>
                {cvOut}
                <div style={{ display:"flex", gap:"8px", marginTop:"8px" }}>
                  <button style={{ ...C.btn("#a78bfa"), fontSize:"10px" }} onClick={()=>navigator.clipboard.writeText(cvOut)}>📋 Copy All</button>
                </div>
              </div>
            )}
          </div>
