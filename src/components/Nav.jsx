    ...
    <>
      ...
      <nav style={{ background: WHITE, borderBottom: "2px solid #EEF2FF", position: "sticky", top: 0, zIndex: 200, boxShadow: "0 2px 12px rgba(79,70,229,0.06)" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 clamp(16px,3vw,40px)", height: 70, maxWidth: 1400, margin: "0 auto" }}>
          ...
          {/* MOBILE HAMBURGER */}
          <button onClick={() => setMobile(!mobileOpen)} className="nav-mobile-btn" style={{
            background: "transparent", border: "none", cursor: "pointer",
            color: DARK, fontSize: 22, padding: 8, display: "none",
          }}>☰</button>
        </div>
        ...
        {mobileOpen && (
          <div style={{ background: WHITE, borderTop: "1px solid #E5E7EB", padding: "16px 20px" }}>
            ...
            <div style={{ display: "flex", gap: 10, flexDirection: "column" }}>
              <button onClick={() => go("partnerlogin")} style={{ background: "transparent", border: "1px solid #E5E7EB", color: DARK, fontSize: 13, fontWeight: 500, padding: 12, borderRadius: 6, cursor: "pointer", fontFamily: "inherit" }}>Partner Login</button>
