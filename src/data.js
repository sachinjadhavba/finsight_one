// ─── FINSIGHTONE DATA — Locked Stream Architecture (S1–S4) ───
...
export const SERVICES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Detailed Eligibility Report", price: "₹499–999" },
      { name: "Loan Readiness Improvement Plan", price: "₹2,499–4,999" },
      { name: "Full Banker Presentation", price: "₹9,999–14,999" },
      { name: "Rejected Loan Recovery", price: "₹4,999–7,999" },
    ],
    btn: "Get My Free Check →", page: "check",
    numColor: "#7C3AED", priceColor: "#7C3AED",
    headBg: "linear-gradient(135deg,#F5F3FF,#EDE9FE)",
  ...
  },
  {
    ...
    items: [
      { name: "Monthly Business Health Report", price: "₹2,999/mo" },
      { name: "Working Capital Alerts", price: "₹1,999/mo" },
      { name: "Custom MIS Dashboard", price: "₹4,999/mo" },
      { name: "Credit Score Tracking", price: "₹499/mo" },
      { name: "Yearly Financial Health Audit", price: "₹14,999/yr" },
    ],
    btn: "View Monthly Plans →", page: "analytics",
    numColor: "#059669", priceColor: "#059669",
    headBg: "linear-gradient(135deg,#ECFDF5,#D1FAE5)",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Bad Loan / NPA Rescue", price: "₹20K–50K" },
      { name: "New Business Loan Setup", price: "₹10K–20K" },
      { name: "Personal Financial Planning", price: "₹10K–30K" },
    ],
...
export const JOURNEY = [
  ...
  { tag: "Repeat", name: "Next Loan Ready", price: "Full LTV ₹96,797", tagColor: "#FEF3C7", highlight: true },
];
...
// ─── DOCUMENT PRODUCTS (S4 Section A) ───
export const DOC_PRODUCTS = [
  {
    icon: "📑", name: "Loan Application Report (CAM)",
    desc: "The main document banks use to decide on your loan. We prepare it in the exact format your bank uses — covering your business, income, assets, and repayment ability. Available for all 8 loan types.",
...
// ─── ADVISORY PRODUCTS (S4 Section B) ───
export const ADVISORY_PRODUCTS = [
  ...
  {
    icon: "🛡️", name: "Stop Your Loan Going Bad (NPA)",
    desc: "Early warning advisory to prevent your loan from becoming an NPA. We identify the risk signals and give you a recovery plan before the bank takes action.",
    price: "₹20,000 – ₹50,000", who: "For: Businesses with repayment concerns",
  },
  {
  ...
  },
  {
    ...
    desc: "Starting a business and need to set up your first loan? We guide you on how to present your new business to a bank and get your first credit line.",
    price: "₹10,000 – ₹20,000", who: "For: New businesses / startups",
  },
  {
    icon: "👤", name: "Personal Financial Planning",
    desc: "For individuals — home loan, personal loan, or managing multiple EMIs. We help you plan your borrowing smartly and avoid debt traps.",
    price: "₹10,000 – ₹30,000", who: "For: Salaried individuals & families",
  },
];
