...
export const SERVICES = [
  ...
  },
  {
    ...
    items: [
      { name: "LAN Upto 2 Cr",         price: "₹3,999", sample: "/reports/doc-01-cam-small.html" },
      { name: "LAN Upto 5 Cr",         price: "₹4,999", sample: "/reports/doc-02-cam-large.html" },
      { name: "LAN 5 Cr to 10 Cr",     price: "₹9,999", sample: "/reports/doc-03-lan-5to10cr.html" },
      { name: "LAN Above 10 Cr",       price: "On Call", sample: "/reports/doc-04-lan-above10cr.html" },
      { name: "CMA Upto 5 Cr",         price: "₹4,999", sample: "/reports/cma-01-interpretation-1to2cr.html" },
      { name: "CMA 5 Cr to 10 Cr",     price: "₹9,999", sample: "/reports/cma-03-interpretation-5to10cr.html" },
      { name: "CMA Above 10 Cr",       price: "On Call", sample: "/reports/cma-04-interpretation-above10cr.html" },
      { name: "DPR Upto 5 Cr",         price: "₹4,999", sample: "/reports/dpr-02-greenfield-upto5cr.html" },
      { name: "DPR 5 Cr to 10 Cr",     price: "₹9,999", sample: "/reports/dpr-above-5cr-template.html" },
      { name: "DPR Above 10 Cr",       price: "On Call" },
    ],
...
export const PLANS = [
  {
    ...
    features: [
      ...
      "CC utilisation alert with your bank's actual limit — HDFC flags above 75%, not just a generic warning",
      "Intra-month peak utilisation tracking — we flag spikes banks record, not just month-end numbers",
      "Cheque return frequency tracker — 6-month clean record is a positive signal we document",
      "GST filing status check — catch gaps before your bank does",
      "ROC / MCA compliance alert",
      "Monthly bank-view report — 7 signals interpreted from your banker's perspective with named actions and deadlines",
    ],
  },
  {
    ...
    features: [
      ...
      "Monthly review of 8 key banking ratios vs your bank's actual benchmarks — DSCR, debtor days, creditor days, drawing power, turnover vs GST",
      "Traffic light dashboard — Green / Amber / Red against your specific lender's thresholds, not industry averages",
      "Estimated enhancement target with specific Rs. amount and ideal month to approach — not a guess, a calculated figure",
      "One specific fix-it action every month with a clear deadline and exact steps",
      "Quarterly enhancement readiness score — broken down by 6 factors so you know exactly what is holding you back",
      "12-month enhancement calendar — when to prepare, when to approach, what supporting data to bring",
    ],
  },
  {
    ...
    features: [
      ...
      "Dedicated relationship manager — knows your account, your bank, and your numbers personally",
      "Bank-specific enhancement strategy — names what your credit manager looks for and what narrative wins at your specific branch",
      "Enhancement application preparation — amount, justification, supporting data, ready to submit",
      "Banker meeting script — word-for-word opening, exact answers to 5 likely scenarios, what not to volunteer",
      "Pre-meeting mock Q&A — 10 likely credit manager questions with your specific answers and tips",
      "Rate negotiation brief — live competitor rates from HDFC, ICICI, Axis with exact language to use at your renewal",
      "Personal expert note — your dedicated RM reviews every report and writes directly to you by name before delivery",
...
export const WHAT_INCLUDED = [
  ...
  { icon: "📈", title: "Enhancement Readiness Score", desc: "Every quarter we tell you: if you walked into your bank today and asked for a higher limit, here is your actual chance of success — broken down by 6 factors." },
  { icon: "💰", title: "Estimated Enhancement Target", desc: "A specific Rs. amount you can realistically achieve with your current ratios — and the ideal month to walk into your bank and ask. Not a guess. A calculated figure. (Business Health & Premium)" },
  { icon: "🚦", title: "Traffic Light Dashboard", desc: "Eight key banking ratios rated Green, Amber, or Red against your bank's actual benchmarks — not generic industry averages. Your lender's specific thresholds, not ours." },
  { icon: "🎯", title: "Monthly Fix-It Action", desc: "One specific, precise instruction every month based on your exact numbers — not generic advice but a clear action with a named deadline." },
  { icon: "📅", title: "12-Month Enhancement Calendar", desc: "A full-year roadmap showing when to prepare your financials, when to approach the bank, and what supporting data to bring to each meeting." },
  { icon: "💹", title: "Rate Negotiation Brief", desc: "Live competitor rates from HDFC, ICICI, Axis, and other banks — with exact language to use at your next renewal to negotiate a lower rate. (Premium)" },
  { icon: "🤝", title: "Banker Meeting Prep", desc: "Word-for-word meeting script, 10 mock Q&A questions with your specific answers, and post-meeting debrief — so every banker conversation moves you closer to a higher limit. (Premium)" },
];
...
export const DOC_PRODUCTS = [
  {
    ...
    priceDetail: "Upto 2 Cr: ₹3,999  |  Upto 5 Cr: ₹4,999  |  5 Cr to 10 Cr: ₹9,999  |  Above 10 Cr: Confirm on Call",
    ...
    samples: [
      ...
      { url: "/reports/doc-03-lan-5to10cr.html", label: "Sample 5–10 Cr" },
      { url: "/reports/doc-04-lan-above10cr.html", label: "Sample Above 10 Cr" },
    ],
  },
  {
    ...
    priceDetail: "Upto 5 Cr: ₹4,999  |  5 Cr to 10 Cr: ₹9,999  |  Above 10 Cr: Confirm on Call",
    ...
    samples: [
      ...
      { url: "/reports/cma-03-interpretation-5to10cr.html", label: "Sample 5–10 Cr" },
      { url: "/reports/cma-04-interpretation-above10cr.html", label: "Sample Above 10 Cr" },
    ],
  },
  {
    ...
    samples: [
      ...
      { url: "/reports/dpr-above-5cr-template.html", label: "Sample 5–10 Cr" },
    ],
  },
];
...
export const CREDENTIALS = [
  { period: "2005 to 2010", title: "Retail Lending Officer", org: "Leading Public Sector Bank · Home & Personal Loans" },
  { period: "2010 to 2018", title: "MSME Credit Manager", org: "Mid-Size Private Bank · Working Capital & Term Loans" },
  { period: "2018 to 2023", title: "Senior Credit Analyst", org: "Large NBFC · Project Finance & Structured Lending" },
  { period: "2023 to 2024", title: "Independent Consultant", org: "MSME Advisory · Helped 100+ businesses get approved" },
  { period: "2025 to Present", title: "Founder, FinsightOne", org: "India's Credit & Loan Advisory Platform" },
];
