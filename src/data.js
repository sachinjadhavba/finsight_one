...
export const SERVICES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Detailed Eligibility Report", price: "₹499–999", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Loan Readiness Plan", price: "₹2,499–4,999", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Full Banker Presentation", price: "₹9,999–14,999", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Rejected Loan Recovery", price: "₹4,999–7,999", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
    ],
  ...
  },
  {
    ...
    items: [
      { name: "Monthly Business Health Report", price: "₹2,999/mo", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Working Capital Alerts", price: "₹1,999/mo", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Custom MIS Dashboard", price: "₹4,999/mo", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Credit Score Tracking", price: "₹499/mo", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
      { name: "Yearly Financial Health Audit", price: "₹14,999/yr", sample: "/reports/business-services/05_loan_readiness_pharma.html" },
    ],
